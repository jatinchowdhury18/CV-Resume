...
%---------------------------------------------------------
  \cventry
    ...
    {Code Generation Workflows for Circuit Emulation} % Organization/group
    {Cambridge, MA} % Location
    {June 2025 - PRESENT} % Date(s)
    {
      \begin{cvitems} % Description(s) of experience/contributions/knowledge
        \item {Developed code generation systems for generating optimized implementations of circuit models using either Wave Digital Filters or nodal analysis.}
        \item {Developed a textual representation of Wave Digital circuit topology.}
        \item {Developed analysis tools for ``reducing'' circuit model complexity.}
      \end{cvitems}
    }
